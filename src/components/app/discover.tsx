    ...
    <section className="font-inter container mx-auto pl-2.5 pr-2.5 pt-16 lg:pt-24 lg:px-10">
      <div className="flex flex-col gap-14 md:gap-20">
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-white via-white/80 to-transparent backdrop-blur-sm flex items-center justify-center backdrop-opacity-5">
